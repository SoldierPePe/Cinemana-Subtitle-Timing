...
jQuery(function () {
    jQuery(".vjs-track-settings-font").prepend('<fieldset class="vjs-fg-color vjs-track-setting"><legend id="subtitle-timing">Subtitle Timing <a href="https://www.facebook.com/Ahmed.M.H.Alnajjar"target="_blank">By SoldierPePe</a> V0.1</legend><div class="vjs-track-settings-controls"><input id="timing-val" type="number" name="Timeing" value="0" step="0.50"class="vjs-default-button"><select class="CET-LANG-SEL"><optgroup class="CET-LANG" label="Languegs"></optgroup> </select></div><div class="vjs-track-settings-controls"><button class="btn btn-xs" type="button" style="margin: 0px 0px 22px 10px;" onclick="ChengSubTime()">Apply</button></div></fieldset>');
